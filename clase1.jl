...
# ╔═╡ e8cdb295-2a8d-43c8-aef6-a8c204e3e8fc
using Plots

# ╔═╡ 7b121563-017c-454e-a44d-24f603189cbe
using PlutoUI

# ╔═╡ 010ef873-d8c0-4590-a2bc-2ec37553bda6
using GLMakie: streamplot, Point2

# ╔═╡ ebc90fc0-c5b3-4294-b632-4ee19d9daf74
md"""
### Ejercicio 1
"""

# ╔═╡ ab331946-3c31-11ee-0ef4-3d4a3df03bae
function euler(f,t0,tf,h,u0)
	t = t0:h:tf
	n = length(t)
	u = zeros(n)
	u[1] = u0
...
# ╔═╡ 1e9bc648-4f10-494f-9ca4-cae6a597306a
# ╠═╡ disabled = true
#=╠═╡
@bind λ Slider(-30:0.01:30)
  ╠═╡ =#

# ╔═╡ 07303959-df12-46c8-b7b3-8c0ed65c66e2
@bind h Slider(0.1:0.01:1)

# ╔═╡ ae49f920-f6ff-4c41-b6a0-c686cda5eaef
#=╠═╡
begin
	g(t,y)= λ*y
	T,U = euler(g,0,10,h,1)
end
  ╠═╡ =#

# ╔═╡ 8d31cdfe-fb56-4b23-9c4d-32258a315fc0
#=╠═╡
plot(T,U,title = " λ = ")
  ╠═╡ =#

# ╔═╡ 74d16f52-828c-4e34-bc03-79e47d2e908e
function ejercicio1()
	l = 3
	H = 2. .^collect(-2:-1:-8)
	R(t,u) = l*u
...
# ╔═╡ 3eeee969-836e-4eff-a9bb-81311d6eb84e
begin 
	l=3
	m(t,y) = l*y
	lanbdas = 1:10
	...
	plt = plot()
	for h in hs
		t, y = euler(m,0,10,1,h)
		plot!(plt, t ,y, label = "h = $h, λ = $l")
	end
	ts = 0:0.1:10
	plot!(plt,ts, y -> exp.(l*t), label = "e^{λt}")
end

# ╔═╡ 10ad9fe2-4015-4941-b994-421acaaf520b
md"""
### Ejercicio 2
"""

# ╔═╡ 6f9bcbe5-9235-4055-ac63-015ab730a4b6
begin
...
# ╔═╡ 607a228e-4165-40db-8b1a-50acf7b6aae3
begin
	f(t, u) = Point2(1 , -50( u - cos( t )))
	streamplot(f ,-5:5 ,-2:2)
end

# ╔═╡ c7f8de66-2b99-45b0-9031-b5acb85c4acc
md"""
### Ejercicio 3
"""

# ╔═╡ a86a1f88-c55c-4011-adcc-028b33e32be8
@bind k Slider(0.1:0.1:10)

# ╔═╡ 656b3df7-afde-4982-8fb2-a79baf9f0c44
@bind r Slider(-10:0.1:10)

# ╔═╡ 3a49de79-18ce-4e12-87a2-3b618ff78b4d
begin
	n(t, P) = Point2(1 , r*P*(1-(P/k)))
	streamplot(n ,-10:10 ,-2:2)
end

# ╔═╡ 98d40160-70ab-477c-a6e5-4f58306ed222
begin
	logistica(t, P) = Point2(1 , r*P*(1-(P/k)))
	streamplot(logistica ,-10:10 ,-2:2)
end
