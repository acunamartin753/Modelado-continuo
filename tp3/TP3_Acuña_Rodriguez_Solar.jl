...
function graficar_transporte(;α=0.2,r=0.5,β=10,N=20,g=bola,Tf=1,paso=1,Tlim=10^10) 
    ...
    @gif for t in 1:paso:min(Tlim,T)
		surface(Ω,Ω, u[:,:, t], zlims=(u_min,u_max), clims = (u_min,u_max), title=string("α=",α," r=",r," β=",β))
    end
end
