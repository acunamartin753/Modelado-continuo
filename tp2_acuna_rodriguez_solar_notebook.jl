...
# ╔═╡ acb31441-1642-4e92-91df-5cf1ab7dc92e
...
# Para comprimir una imagen usamos la funcion comprimir y pasamos el nombre del archivo como parametro. Este sera guardado con el mismo nombre pero con extension .comp
# Definimos las matrices de cuantificacion quant1 y quant2. Por default la compresion se hace usando quant1 pero opcionalmente se puede pasar una matriz de cuantizacion como parametro si se desea usar otra
# Ademas de comprimir la imagen y guardar un archivo, la funcion comprimir devuelve las dimensiones de la imagen original. Podemos guardar estas medidas en una variable auxiliar
# Se puede observar que los archivos comprimidos tienen menor tamaño que los originales
# Para descomprimir un archivo usamos la funcion descomprimir pasandole como parametro el nombre del archivo original pero con la extension .comp
# Opcionalmente, podemos pasarle las medidas de la imagen original si deseamos sacar el relleno de los bordes que se añadió para hacer la compresion. En caso de no pasarle este parametro, la imagen descomprimida conserva el relleno
# La imagen comprimida se guarda en un archivo con el mismo nombre original mas el texto "_descomp" con formato .bmp
# Este ultimo archivo ya no tiene menor tamaño necesariamente pero sirve para ver que la descompresion se realiza correctamente
...
# ╔═╡ 8d127e2f-5bfb-4222-a6ac-0ddd4534f279
#begin
...
# ╔═╡ 405b0f3c-9371-4f47-9a73-481af16a5f83
#begin
# 	Otros ejemplos
...
# ╔═╡ 8f67a911-a445-4907-a005-422575f94a39
#begin
# 	Otros ejemplos
